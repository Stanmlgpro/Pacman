...
void PausedState::Render(sf::RenderWindow &window) {
  ...
  title.setPosition(
      window.getSize().x / 2.f - title.getGlobalBounds().width / 2.f, 100.f);
  resumeHint.setPosition(window.getSize().x / 2.f -
                             resumeHint.getGlobalBounds().width / 2.f,
                         250.f);
  menuHint.setPosition(
      window.getSize().x / 2.f - menuHint.getGlobalBounds().width / 2.f, 310.f);
