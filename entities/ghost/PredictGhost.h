 ...
 *
 * 1 of 3 types of Ghost, this one targets the position in front of pacman
 */
class PredictGhost final : public Ghost {
public:
    /**
     ...
     */
    PredictGhost(float x, float y, std::shared_ptr<Pacman> pacman, const std::vector<std::vector<bool>>& wallgrid,
