...
namespace views {
SFMLLockedGhostView::SFMLLockedGhostView(
...
void SFMLLockedGhostView::FindSprite() {
  ...
  if (e->getFeared() and e->getFearCheck() < 4.f) {
    ...
    if (e->getDying())
      ...
      rect = animation_bool
                 ? atlas->get(sprites::Sprite_ID::GHOST_YELLOW_LEFT_1)
    ...
    if (e->getDying())
      ...
      rect = animation_bool
                 ? atlas->get(sprites::Sprite_ID::GHOST_YELLOW_DOWN_1)
    ...
    if (e->getDying())
      ...
      rect = animation_bool
                 ? atlas->get(sprites::Sprite_ID::GHOST_YELLOW_RIGHT_1)
