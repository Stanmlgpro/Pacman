...
namespace views {
SFMLPredictGhost1View::SFMLPredictGhost1View(
...
void SFMLPredictGhost1View::FindSprite() {
  ...
  if (e->getFeared() and e->getFearCheck() < 4.f) {
    ...
    if (e->getDying())
      ...
      rect = animation_bool
                 ? atlas->get(sprites::Sprite_ID::GHOST_WHITE_LEFT_1)
    ...
    if (e->getDying())
      ...
      rect = animation_bool
                 ? atlas->get(sprites::Sprite_ID::GHOST_WHITE_DOWN_1)
    ...
    if (e->getDying())
      ...
      rect = animation_bool
                 ? atlas->get(sprites::Sprite_ID::GHOST_WHITE_RIGHT_1)
